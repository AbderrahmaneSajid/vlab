...
const Add = () => {
    ...
    return (
      <div>  
      <div className='H'><h1>Ajouter un nouveau prélévement</h1></div>
      ...
      <div className='form'>
         ...
         <div className='f'>
          ...
          <select name='labdestination' value={book.labdestination} onChange={handleChange}>
      ...
      <div className='buttoncont'><button className='add' onClick={handleClick}>Ajouter</button></div>
      </div>
    );
